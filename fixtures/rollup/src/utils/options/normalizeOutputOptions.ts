...
export function normalizeOutputOptions(
  ...
  const outputOptions: NormalizedOutputOptions & OutputOptions = {
    amd: getAmd(config),
    assetFileNames:
      (config.assetFileNames as string | undefined) ??
      'assets/[name]-[hash][extname]',
    banner: getAddon(config, 'banner'),
    chunkFileNames:
      (config.chunkFileNames as string | undefined) ?? '[name]-[hash].js',
    compact,
    ...
    externalLiveBindings:
      (config.externalLiveBindings as boolean | undefined) ?? true,
    file,
    ...
    hoistTransitiveImports:
      (config.hoistTransitiveImports as boolean | undefined) ?? true,
    ...
    namespaceToStringTag:
      (config.namespaceToStringTag as boolean | undefined) || false,
    ...
    preserveModules,
    sourcemap:
      (config.sourcemap as boolean | 'inline' | 'hidden' | undefined) || false,
    sourcemapExcludeSources:
      (config.sourcemapExcludeSources as boolean | undefined) || false,
    ...
    systemNullSetters:
      (config.systemNullSetters as boolean | undefined) || false,
  };
